...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
        ...
        cy.get('#email').type('victormendes@exemplo.com')
    ...
    it('Prrenche e limpa os campos nome, sobrenome, email e telefone', function (){
        ...
        cy.get('#email')
            .type('victormendes@exemplo.com')
            .should('have.value', 'victormendes@exemplo.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('31998870098')
    ...
    it('preenche a area de texto usando o comando invoke', function() {
        const longText = Cypress._.repeat('texto amostra', 20)
